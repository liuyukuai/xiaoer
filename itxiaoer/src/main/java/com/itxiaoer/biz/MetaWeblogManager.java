...
import com.itxiaoer.core.dal.constants.CategoryConstants;
...
import com.itxiaoer.service.TagService;
...
public class MetaWeblogManager {
	...
	public Object getPost(String postid, String username, String pwd) {
		...
		mc.put("title", post.getTitle()).put("link", WebConstants.getDomainLink("/posts/" + postid)).put("permaLink",
				WebConstants.getDomainLink("/posts/" + postid));
	...
	public Object getCategories(String blogid, String username, String pwd) {
		...
		for (MapContainer category : categories) {
			...
			MapContainer mc = new MapContainer("categoryid", category.getAsString("id"))
					...
					.put("htmlUrl", WebConstants.getDomainLink("/categorys/" + category.getAsString("name")))
					.put("rssUrl", "");
			result.add(mc);
		}
